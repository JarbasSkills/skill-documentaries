...
class DocumentariesSkill(CommonPlaySkill):
    ...
    def __init__(self):
        ...
        # load video catalog
        videos = Collection("Documentaries",
                            logo=join(dirname(__file__), "res",
                                      "documentaries_logo.png"),
                            db_path=path)
    ...
    def initialize(self):
        self.add_event('skill-documentaries.jarbasskills.home',
                       self.handle_homescreen)
        self.gui.register_handler(
            "skill-documentaries.jarbasskills.play_event",
                                  self.play_video_event)
        self.gui.register_handler(
            "skill-documentaries.jarbasskills.clear_history",
    ...
    def handle_homescreen(self, message):
        ...
        self.gui["historyModel"] = JsonStorageXDG("documentaries-history")\
            .get("model", [])
    ...
    def add_to_history(self, video_data):
        # History
        historyDB = JsonStorageXDG("documentaries-history")
    ...
    def CPS_match_query_phrase(self, phrase, media_type):
        ...
        if not best_video:
            self.log.debug("No Documentaries matches")
            return None
        ...
        self.log.debug("Best Documentaries video: " + best_video["title"])
